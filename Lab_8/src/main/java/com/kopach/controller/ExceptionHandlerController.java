...
public class ExceptionHandlerController extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NoSuchGroupOfStudentException.class)
    ...
    @ExceptionHandler(NoSuchLecturerException.class)
    ...
    @ExceptionHandler(ExistsStudentsForGroupOfStudentException.class)
    ...
    @ExceptionHandler(ExistsStudentForProjectException.class)
    ...
    @ExceptionHandler(ExistsLecturerForStudentException.class)
    ...
    @ExceptionHandler(AlreadyExistsStudentInLecturerException.class)
    ...
    @ExceptionHandler(StudentAbsentException.class)
    ...
    @ExceptionHandler(LecturerHasNotStudentException.class)
